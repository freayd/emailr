module AccountsHelper
  ...
  #
  # Example:
  # <%= if_account_authorized?(:index,   User)  do link_to('List all users', users_path) end %> |
  # <%= if_account_authorized?(:edit,    @user) do link_to('Edit this user', edit_user_path) end %> |
  # <%= if_account_authorized?(:destroy, @user) do link_to 'Destroy', @user, :confirm => 'Are you sure?', :method => :delete end %> 
  #
  #
  def if_account_authorized?(action, resource, &block)
  ...
  #
  # Examples:
  #   link_to_account_login_with_IP
  #   # => <a href="/login" title="169.69.69.69">169.69.69.69</a>
  #
  #   link_to_account_login_with_IP :content_text => 'not signed in'
  #   # => <a href="/login" title="169.69.69.69">not signed in</a>
  #
  def link_to_account_login_with_IP content_text=nil, options={}
  ...
  # (using _accountlink_to_login_with_IP).
  #
  def link_to_current_account(options={})
    if current_account
      ...
      link_to_account_login_with_IP content_text, options
    end
  end
